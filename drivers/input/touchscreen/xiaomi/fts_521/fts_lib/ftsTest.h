...
#define LIMITS_FILE \
	"stm_fts_production_limits.csv" /*Name of the Production Test Limit File*/
#else
#define LIMITS_FILE "NULL"
#endif

#define WAIT_FOR_FRESH_FRAMES \
	200 /*Time in ms to wait after start to sensing before reading a frame*/
#define WAIT_AFTER_SENSEOFF \
	50 /*Time in ms to wait after stop sensing and before reading a frame from memory*/

#define NO_INIT 0 /*No Initialization required during the MP*/

#define RETRY_INIT_BOOT \
	3 /*number of retry of the initialization process at boot*/
