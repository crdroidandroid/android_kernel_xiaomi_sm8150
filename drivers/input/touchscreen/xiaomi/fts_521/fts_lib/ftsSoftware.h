...
#define FEAT_SEL_STYLUS \
	0x07 /*Stylus Mode (this is a driver define, not available in FW)*/
/** @}*/
...
#define ITO_FORCE_GROUND \
	0x02 /*Check if some force channels is short to ground*/
#define ITO_SENSE_GROUND \
	0x03 /*Check if some sense channels is short to ground*/
...
#define ITO_KEY_FORCE_OPEN \
	0x09 /*Check if some force channels used for the key is open*/
#define ITO_KEY_SENSE_OPEN \
	0x0A /*Check if some sense channels used for the key is open*/
/** @}*/
...
#define LOAD_PANEL_CX_TOT_MS_TOUCH \
	0x50 /*Load TOT MS Init Data for Active Mode*/
#define LOAD_PANEL_CX_TOT_MS_LOW_POWER \
	0x51 /*Load TOT MS Init Data for Low Power Mode*/
#define LOAD_PANEL_CX_TOT_SS_TOUCH \
	0x52 /*Load TOT SS Init Data for Active Mode*/
#define LOAD_PANEL_CX_TOT_SS_TOUCH_IDLE \
	0x53 /*Load TOT SS Init Data for Low Power Mode*/
...
#define STAPI_HOST_DATA_ID_PANEL_CX_SS_HVR \
	0x58 /*Load HOVER TOT SS Init Data for Activity*/
...
#define EVT_ID_CONTROLLER_READY \
	0x03 /*Controller ready, issued after a system reset.*/
#define EVT_ID_ENTER_POINT 0x13 /*Touch enter in the sensing area*/
#define EVT_ID_MOTION_POINT \
	0x23 /*Touch motion (a specific touch changed position)*/
...
#define EVT_ID_USER_REPORT \
	0x53 /*User related events triggered (keys, gestures, proximity etc)*/
#define EVT_ID_DEBUG 0xE3 /*Debug Info*/
#define EVT_ID_ERROR 0xF3 /*Error Event*/

#define NUM_EVT_ID                      \
	(((EVT_ID_ERROR & 0xF0) >> 4) + \
	 1) /*Max number of unique event IDs supported*/
/** @}*/
...
#define EVT_TYPE_STATUS_ECHO \
	0x01 /*Echo event, contain the first 5 bytes of the FW command sent*/
#define EVT_TYPE_STATUS_FRAME_DROP \
	0x03 /*Some frame was skipped during the elaboration*/
...
#define EVT_TYPE_ERROR_CRC_PANEL_HEAD \
	0x22 /*CRC error in the Panel Area Header*/
...
#define EVT_TYPE_ERROR_CRC_CX_SUB_HEAD \
	0xA5 /*CRC error in the CX Subsection Area Header*/
...
#define ADDR_CONFIG_SENSE_LEN \
	0x0030 /*Address where is stored the number of sense channels*/
#define ADDR_CONFIG_FORCE_LEN \
	0x0031 /*Address where is stored the number of force channels*/
/** @}*/
...
#define ERROR_DUMP_COL_SIZE \
	4 /*number of bytes for each row of the error memory*/
