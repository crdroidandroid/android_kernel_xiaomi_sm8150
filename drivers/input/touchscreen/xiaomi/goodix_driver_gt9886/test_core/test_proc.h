...
extern s32 get_test_item_by_another_item(u16 item_id,
					 PST_TEST_ITEM p_src_test_item,
					 PST_TEST_ITEM *pp_des_test_item);
extern s32 register_test_item_func(PST_TEST_PROC_DATA p_test_proc_data);
extern s32 get_test_item_from_proc_data(PST_TEST_PROC_DATA p_test_proc_data,
					u16 test_item_id,
					PST_TEST_ITEM *pp_test_item);
