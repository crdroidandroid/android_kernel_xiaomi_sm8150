...
/*//other test*/
#define TP_CHIP_CFG_PROC_ITEM_ID \
	1200 /*/cfg check,check cfg in chip whether ok or not,or send config*/
#define TP_FLASH_TEST_ITEM_ID \
	1201 /*//flash test using send cfg ,reset chip,then read and compare cfg*/
...
#define TP_CUSTOM_INFO_TEST_ITEM_ID \
	1204 /*//custom information:including write information or check information*/
