...
extern s32 normandy_reg_write(PST_TP_DEV p_dev, u16 addr, u8 *p_buf,
			      u16 buf_len);
extern s32 normandy_reg_read(PST_TP_DEV p_dev, u16 addr, u8 *p_buf,
			     u16 buf_len);
...
extern s32 normandy_ctrl_chip_io(PST_TP_DEV p_dev, u16 io_id,
				 GIOMode_Def modeType);
extern s32 normandy_setbit_chip_io(PST_TP_DEV p_dev, u16 io_id,
...
extern s32 normandy_write_custom_info(PST_TP_DEV p_dev,
				      PST_CUSTOM_INFO_BYTE custom_info, u8 len);
extern s32 normandy_read_custom_info(PST_TP_DEV p_dev,
				     PST_CUSTOM_INFO_BYTE custom_info, u8 len);
extern s32 normandy_doze_mode(PST_TP_DEV p_dev, u8 b_ena, u8 b_force);
extern s32 normandy_check_chip_test_res_info(IN PST_TP_DEV p_dev,
					     IN u8 *test_res_info, IN u32 len);
/*************************************Public methods End********************************************/
#ifdef __cplusplus
}
#endif
